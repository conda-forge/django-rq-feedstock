About django-rq-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-rq-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3853&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-rq-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-rq` can be installed with `conda`:
...
```
mamba install django-rq
```

It is possible to list all of the versions of `django-rq` available on your platform with `conda`:
...
```
mamba search django-rq --channel conda-forge
```
...
mamba repoquery search django-rq --channel conda-forge

# List packages depending on `django-rq`:
mamba repoquery whoneeds django-rq --channel conda-forge

# List dependencies of `django-rq`:
mamba repoquery depends django-rq --channel conda-forge
```
